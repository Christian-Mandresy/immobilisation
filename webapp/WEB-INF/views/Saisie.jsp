              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <sf:form method="POST" modelAttribute="Materiel" action="AjoutMateriel" cssClass="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <sf:input path="date_achat" cssClass="form-control" placeholder="date d'achat" type="date"/>
                      </div>
                      <div class="form-group">
                        <label for="date service">Date de mise en service</label>
                        <sf:input path="date_service" cssClass="form-control" placeholder="date de mise en service" type="date"/>
                      </div>
                      <div class="form-group">
